...
import (
	...
	"github.com/beadlima/research-api/stages/05-full-microservices/users-service/internal/db"
	"github.com/beadlima/research-api/stages/05-full-microservices/users-service/internal/handlers"
	"github.com/beadlima/research-api/stages/05-full-microservices/users-service/internal/middleware"
...
func main() {
	...
	middleware.RegisterPoolCollector("users-service", pool)
	...
	r.Get("/health", func(w http.ResponseWriter, r *http.Request) {
		if err := pool.Ping(r.Context()); err != nil {
			...
			w.Write([]byte(`{"status":"degraded","service":"users-service","db":"down"}`))
			return
		}
		w.Header().Set("Content-Type", "application/json")
