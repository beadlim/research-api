...
import (
	...
	"github.com/beadlima/research-api/products-service/internal/db"
	"github.com/beadlima/research-api/products-service/internal/handlers"
	"github.com/beadlima/research-api/products-service/internal/middleware"
...
func main() {
	...
	middleware.RegisterPoolCollector("products-service", pool)
