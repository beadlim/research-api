...
import (
	...
	"github.com/beadlima/research-api/monolith-partial/internal/db"
	"github.com/beadlima/research-api/monolith-partial/internal/handlers"
	"github.com/beadlima/research-api/monolith-partial/internal/middleware"
...
func main() {
	...
	middleware.RegisterPoolCollector("monolith-partial", pool)
	...
	r.Get("/health", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Write([]byte(`{"status":"ok","service":"monolith-partial"}`))
	})
	r.Handle("/metrics", promhttp.Handler())

	// /users removido — agora roteado pelo NGINX para users-service
	...
	go func() {
		log.Println("monolith-partial listening on :8080")
